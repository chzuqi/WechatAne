...
echo cp -f "$CONFIGURATION_BUILD_DIR"/"$TARGET_NAME" /Users/czq/Documents/Adobe Flash Builder 4.6/Test/libs/WeixinSdk.ane
cp -f "$CONFIGURATION_BUILD_DIR"/"$TARGET_NAME" /Users/czq/Documents/Adobe\ Flash\ Builder\ 4.6/Test/libs/